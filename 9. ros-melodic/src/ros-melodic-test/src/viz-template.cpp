 ...
 * @LastEditTime: 2020-09-16 14:19:01
 * @FilePath: /3rd-test-learning/9. ros-melodic/src/ros-melodic-test/src/viz-template.cpp
 * @Description: 目前版本的rviz 不知道是不是为本人电脑的问题 sphere_list 还有cube_list 最后显示的结果就是一堆点
 *               而不是预想中的球和方形
 */
